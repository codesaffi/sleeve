...
const Hero = () => {
  return (
    <div className='hero-paper relative w-full overflow-hidden bg-background min-h-[600px] flex items-center border-b-2 border-primary'>
      ...
      <div className='relative z-10 container mx-auto px-6 sm:px-12 py-16 md:py-24 flex flex-col md:flex-row items-center justify-between gap-12'>
        ...
        >
            ...
            <div className="hero-print relative w-full max-w-lg aspect-[3/4] sm:aspect-square bg-white border-2 border-primary p-3 shadow-[8px_8px_0px_0px_rgba(26,26,26,1)] group overflow-hidden halftone-bg">
                  <div className="w-full h-full overflow-hidden transform transition-transform duration-700 group-hover:scale-[1.02] border border-primary/40 bg-background p-2">
                    <img src={assets.banner} alt="Banner" className="w-full h-full object-cover grayscale-[0.2] contrast-125 sepia-[0.1]" />
                </div>
                  <span className="hero-print-label" aria-hidden="true">SIDE A · SLEEVE ARCHIVE</span>
              </div>
              <span className="hero-handwritten" aria-hidden="true">good things sound better framed</span>
